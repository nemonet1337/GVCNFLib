       ...
       // 		System.out.println(String.format("%1$.2f", message.posy));
        ...
        if(message.key == 444){
        	...
        	if (en != null && en instanceof EntityGVCLivingBase) {// 1
        		...
        		if(en.getControllingPassenger() != null  && en.getControllingPassenger() == entityPlayer) {
        ...
        if(message.key == 548){
        	EntityLivingBase en = (EntityLivingBase) entityPlayer.world.getEntityByID(message.fre);
        	if (en != null) {// 1
        		en.setPosition(message.posx,message.posy, message.posz);
        	}
        }
        ...
        if(message.key == 203){
        	...
        	if (en != null && en instanceof EntityGVCLivingBase) {// 1
        		EntityGVCLivingBase base = (EntityGVCLivingBase) en;
        		Entity ta = entityPlayer.world.getEntityByID(message.da);
