...
public class GVCLMessageKeyPressed implements IMessage {
    ...
    public GVCLMessageKeyPressed(int i, int entity, float x, float y, float z, int xx) {
        this.key = i;
        this.fre = entity;
        this.posx = x;
        this.posy = y;
    ...
    /**600専用*/
    public GVCLMessageKeyPressed(int i, int entity, float fo, float sr, int iiii) {
        this.key = i;
        this.fre = entity;
        this.Forward = fo;
        this.Strafing = sr;
