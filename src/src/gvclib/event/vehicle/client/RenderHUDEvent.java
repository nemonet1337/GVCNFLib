...
public class RenderHUDEvent extends Gui {
	...
	public void renderAntiLockOn(Minecraft minecraft, EntityGVCLivingBase balaam, EntityPlayer entityplayer, int i, int j, int id) {
		FontRenderer fontrenderer = minecraft.fontRenderer;
		minecraft.entityRenderer.setupOverlayRendering();
		ScaledResolution scaledresolution = new ScaledResolution(minecraft);
		...
		fontrenderer.drawStringWithShadow("WARNING!", scaledresolution.getScaledWidth()/2 - 10,  scaledresolution.getScaledHeight()/2 + 20, color);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		GL11.glPopMatrix();//22
