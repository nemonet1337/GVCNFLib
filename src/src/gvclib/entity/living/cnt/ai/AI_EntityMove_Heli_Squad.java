...
//		ridding.rotationYaw = ridding.rotationYawHead = entity.rotationYaw;
		if (!ridding.getTargetEntity_isLiving() || owner_range(ridding, 60)){
		...
		if(ridding.getMoveT() == 2){
			{
				double d51 = entity.getMoveX() - entity.posX;
				double d71 = entity.getMoveZ()- entity.posZ;
				double d61 = entity.getMoveY() - entity.posY;
