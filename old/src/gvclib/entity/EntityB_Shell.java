...
public class EntityB_Shell extends EntityBBase {
	...
	public void onUpdate()
    {
        ...
        {
        	//if (this.world.isRemote) this.world.spawnParticle(EnumParticleTypes.CLOUD, true, this.posX, this.posY + 0D, this.posZ, 0.0D, 0.0D, 0.0D);
        	 if (!this.world.isRemote && this.world instanceof WorldServer)
             {
        		 WorldServer server = (WorldServer) this.world;
        		 server.spawnParticle(EnumParticleTypes.CLOUD, true, this.posX, this.posY, this.posZ, 1, 0.0D, 0.0D, 0.0D, 0D, 0);
             }
        }
